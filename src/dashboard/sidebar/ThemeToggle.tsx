...
export default function ThemeToggle() {
  ...
  return (
    <div>
      ...
      />
      <label
        className="flex h-8 w-8 cursor-pointer items-center justify-center rounded-full bg-[#259F83] hover:bg-[#259F83] dark:bg-slate-700 dark:hover:bg-slate-600/80"
      ...
      >
        ...
        >
          <path
            className="fill-current text-[#259F83]"
