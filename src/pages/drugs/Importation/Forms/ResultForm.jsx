        ...
        <div className=" flex h-full w-full flex-col">
          <form className="grid grid-cols-1 items-center gap-10 dark:text-white-text sm:justify-items-center">
            <div className="input-container relative">
              ...
              <div className="ps-container mt-1 h-24 w-full flex justify-center items-center gap-4 xl:gap-10 sm:px-6 rounded-full border border-[#259f8300] dark:border-black-border bg-white-bg dark:bg-black-shadow px-4 py-2 font-normal shadow-md dark:shadow-black-shadow outline-none focus:border-[#5cd3b7] focus:outline-none focus:ring-2 focus:ring-[#5cd3b7] dark:focus:ring-2 dark:focus:ring-[#5cd3b7]">
                <div className="col-1 flex flex-col w-full border-b-2 border-[#259f8359]">
                  ...
                  <input
                    ...
                    className="border-none text-[#259f83] font-bold focus:ring-transparent outline-none p-2 bg-white-bg dark:bg-black-shadow rounded-full"
                    type="text"
                    placeholder=""
                  />
                </div>
              ...
              <div className="inputs-container mt-1 h-24 w-full flex justify-center items-center gap-4 xl:gap-10 sm:px-6 rounded-full border border-[#259f8300] dark:border-black-border bg-white-bg dark:bg-black-input px-4 py-2 font-normal shadow-md dark:shadow-black-shadow outline-none focus:border-[#5cd3b7] focus:outline-none focus:ring-2 focus:ring-[#5cd3b7] dark:focus:ring-2 dark:focus:ring-[#5cd3b7]">
                <div className="col-1 flex flex-col w-16 md:w-28 border-b-2 border-[#259f8359] hover:border-[#5cd3b7]">
                  ...
                  <input
                    ...
                    className="border-none text-[#259f83] font-bold focus:ring-transparent outline-none p-2 dark:bg-black-input rounded-full"
                    type="text"
                    placeholder=""
                  />
                </div>
                ...
                <div className="col-2 flex flex-col w-[7em] border-b-2 border-[#259f8359] hover:border-[#5cd3b7]">
                  ...
                  <input
                    ...
                    className="border-none cursor-pointer text-[#259f83] font-bold focus:ring-transparent outline-none p-2 dark:bg-black-input rounded-full"
                    type="date"
                    placeholder=""
                  />
                </div>
                ...
                <div class="col-4 flex flex-col w-16 sm:w-full border-2 border-[#259F83] rounded-full transition-all hover:border-[#5cd3b7]">
                  {uploadedPI ? (
                    <div
                    ...
                    <label className="flex items-center justify-center bg-white text-[#259f83] font-bold p-2 dark:bg-black-input rounded-full cursor-pointer border-none">
                      <span>Attach</span>
                      <input
                        type="file"
                        id="attach"
