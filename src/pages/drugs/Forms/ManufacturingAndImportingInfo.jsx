    ...
    <>
      <div className="col-span-1 flex w-[100%] flex-col sm:col-span-1">
        <h1 className="pb-2 pt-4 text-center text-xl sm:py-10 sm:text-2xl ">
          5 - Manufacturing And Importing Information
        </h1>
        ...
        <form className="grid grid-cols-1 items-center gap-10 dark:text-gray-200 sm:grid-cols-2 sm:justify-items-center md:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="input-container flex flex-col">
            ...
            <textarea
              ...
              className="mt-1  rounded-full border border-[#259f8359] bg-white/10 px-4 font-normal shadow-md outline-none focus:border-[#5cd3b7] focus:outline-none focus:ring-1 focus:ring-[#5cd3b7] dark:bg-[#1e1e1e] "
              type="text"
              placeholder=""
            />
          </div>
