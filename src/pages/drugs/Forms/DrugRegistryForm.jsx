...
const DrugRegistryForm = ({
  ...
  return (
    <>
      <div className="col-span-1 flex w-full flex-col text-black-text dark:text-white-text">
        ...
        <div className=" flex h-full w-full flex-col">
          <div className="grid grid-cols-1 items-center gap-10 sm:grid-cols-2 sm:justify-items-center md:grid-cols-2 lg:grid-cols-3">
                  ...
                  (() => {
                    ...
                    if (!isNaN(numericValue) && isFinite(numericValue)) {
                      const formattedValue =
                        numericValue.toLocaleString("en-LB");
