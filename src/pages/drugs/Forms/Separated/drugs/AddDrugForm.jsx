...
const AddDrugForm = () => {
  ...
  return (
    <form className="w-full h-auto my-16 flex flex-col mx-auto" onSubmit={handleSubmit}>
        ...
        <div>
          ...
          <div className="flex flex-col gap-4">
            <div className="inline-">
              <label htmlFor="PriceFOREIGN" className="labels text-md block text-left">
                Foreign Price
              </label>
              <input
                name="PriceFOREIGN"
              ...
              >
                ...
                {Object.entries(currencySymbols).map(([currency, symbol]) => (
                  <option key={currency} value={currency}>
                    {`${symbol} ${currency}`} {/* Display symbol and currency code */}
                  </option>
                ))}
              </select>
            </div>
