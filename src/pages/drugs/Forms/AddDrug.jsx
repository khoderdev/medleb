...
//       return convertedPrice; // Return the raw number
//     }
//     return null; // Use null or another suitable value for no conversion
//   }
...
//   useEffect(() => {
//     // Perform the conversion only if necessary
//     if (formDataStep1.priceForeign && formDataStep1.currencyForeign) {
//       console.log("Price Foreign:", formDataStep1.priceForeign);
//       console.log("Currency Foreign:", formDataStep1.currencyForeign);
...
//       const convertedLBP = convertToLBP(
//         formDataStep1.priceForeign,
//         formDataStep1.currencyForeign
//       );

//       const convertedUSDString =
//         convertedUSD !== null ? Number(convertedUSD).toFixed(2) : "";
//       const convertedLBPString = isNaN(convertedLBP)
//         ? ""
//         : Number(convertedLBP).toFixed(2);

//       console.log("Converted USD:", convertedUSDString);
//       console.log("Converted LBP:", convertedLBPString);

//       // Check if the values have changed to avoid an infinite loop
//       if (
//         convertedUSDString !== formDataStep1.convertToUSD ||
//         convertedLBPString !== formDataStep1.convertToLBP
//       ) {
//         console.log("Updating Form Data");
//         setFormDataStep1((prevFormData) => ({
//           ...prevFormData,
//           convertToUSD: convertedUSDString,
//           convertToLBP: convertedLBPString,
//         }));
//       }
//     }
//   }, [formDataStep1.priceForeign, formDataStep1.currencyForeign]);
...
//   useEffect(() => {
//     // Check if the form is submitted, and it's the last step
//     if (isFormSubmitted && isLastStep) {
//       logFormData();
//     }
//   }, [isFormSubmitted, isLastStep]);

//   const logFormData = () => {
//     console.log("logFormData called");
...
//   useEffect(() => {
//     // Reset isFormSubmitted when the component mounts
...
//       console.log("Submitting Form Data:", finalFormData); // Log the form data being submitted
...
function AddDrug(props) {
  ...
  // Log the values when the component mounts
  useEffect(() => {
    console.log("Converted Price in USD Khoder:", convertToUSD());
    console.log(
      "Converted Price in LBP Khoder:",
