...
import { useDrugDocumentsContext } from '../../../context/DrugDocumentsContext';
...
const DrugDocuments = (props) => {
  ...
  return (
    <div className="image-uploader-cont w-full flex flex-col justify-items-center items-center text-gray-700 dark:text-white-text">
      <h1 className="py-6 text-center text-xl sm:py-10 pb-10 font-medium">3- Medicine Documents</h1>
      ...
      <div className="flex justify-center mt-12">
        <button
          className="med-btn-3rd border-2 border-green-pri hover:bg-green-pri text-white font-bold py-2 px-4 rounded-xl"
          onClick={uploadImages}
          disabled={loading || uploadSuccess}
        >
          {loading ? 'Uploading... please wait' : uploadSuccess ? 'Done ✔' : 'Upload Medicine Docs'}
        </button>
      </div>
    </div>
  );
