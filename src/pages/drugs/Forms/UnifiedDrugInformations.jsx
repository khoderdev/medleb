...
function UnifiedDrugInformations(props) {
  ...
  return (
    <div className="col-span-1 flex flex-col w-full sm:w-[80em] h-full sm:col-span-1 text-black-text dark:text-white-text justify-center ">
        ...
        <table className="whole-table-main-row w-full flex-col overflow-x-hidden ">
          ...
          <thead className="w-full flex justify-center bg-white-input dark:bg-black-shadow">
            <tr className="w-full flex justify-center items-center">
              <div className="AGENT-MAIN-COL w-full flex justify-center border-r border-white-contents dark:border-[#3a3c3d] bg-white-input p-2 text-center text-lg font-bold text-gray-800">
                By the Agent
              </div>
              <div className="IED-MAIN-COL w-full flex justify-center border-l border-white-contents dark:border-[#3a3c3d] bg-white-input p-2 text-center text-lg font-bold text-gray-800">
                By the IED
              </div>
            </tr>
          </thead>
