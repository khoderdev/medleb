...
//     console.log("BatchComponent inputs:", inputs);
//   };
//   return (
...
// }) => {
//   const [localBatchesQty, setLocalBatchesQty] = useState(batchesQty); // Set initial localBatchesQty to batchesQty

//   useEffect(() => {
//     setLocalBatchesQty(batchesQty); // Update localBatchesQty when batchesQty prop changes
//     console.log("Updated LocalBacthesQty:", localBatchesQty);
//   }, [batchesQty]);

//   console.log("ShipmentForm batchComponents:", batchComponents);
//   console.log("ShipmentForm localBatchesQty:", localBatchesQty);

//   const handleIncrement = () => {
//     if (localBatchesQty < 10) {
//       setLocalBatchesQty(localBatchesQty + 1); // Increment localBatchesQty
...
//       setLocalBatchesQty(localBatchesQty - 1); // Decrement localBatchesQty
//       onBatchesQtyChange(localBatchesQty - 1);
//     }
//   };
...
//     console.log("Updated batchesQty:", qty);
//   };

//   const handleAddSerials = (index) => {
//     // Add logic to handle adding serials
//   };
...
//             label: "Batch Number",
//             type: "text",
//             value: batchComponents[index]?.batchNumber || "", // Access batchComponents by index
//           },
//           {
...
//             type: "date",
//             value: batchComponents[index]?.batchProductionDate || "", // Access batchComponents by index
//           },
//           {
...
//             label: "Expiry Date",
//             type: "date",
//             value: batchComponents[index]?.batchExpiryDate || "", // Access batchComponents by index
//           },
//         ]}
//         onAddSerials={() => handleAddSerials(index)}
...
//         />
//         <div>
//           <button onClick={() => handleOpenModal(index)}>Add Serials</button>
//         </div>
//       </div>
//     ));
//   };
