...
const RightColumn = () => (
  <div className="flex md:pl-2 md:pr-4 justify-between w-full bg-white-contents dark:bg-black-bg text-black-text dark:text-white-text h-screen md:min-h-[55%] z-50 overflow-x-hidden">
    {/* Right Column */}
