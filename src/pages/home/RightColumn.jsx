...
const RightColumn = () => {
  return (
    <div className="flex flex-col justify-around  items-center w-full h-screen py-16 lg:pt-4 p-4 lg:pr-8 pb-20 sm:pb-2 gap-4 ">
      <div className="w-full flex flex-col justify-center items-stretch lg:w-[40rem] rounded-xl p-2 py-8 pb-4 lg:py-8 lg:pb-2 overflow-hidden  text-black-bg dark:text-white-text ">
