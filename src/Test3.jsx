          ...
          <tbody>
            <tr>
              <td className="w-[50%] border border-gray-400 p-2">
                ...
                <div className="inputs-container grid w-full grid-cols-1 items-center justify-items-center gap-4 sm:grid-cols-2 md:grid-cols-2 ">
                ...
                {/* <div className="input-container w-full px-20"> */}
            ...
            <tr>
              <td className="w-[50%] border border-gray-400 p-2">
                ...
                <div className="inputs-container grid w-full grid-cols-1 items-center justify-items-center gap-4 sm:grid-cols-2">
                  ...
                  {/* <div className="inputs-container grid w-full grid-cols-1 justify-center gap-4 sm:grid-cols-2"> */}
                  ...
                  <div className="input-container w-full">
                    <div className="flex w-full items-center justify-between">
                      {/* <div className="input-child-container flex w-full justify-between items-center"> */}
                      <label
