...
const BatchSerials = ({ onClose, onAddSerials }) => {
  ...
  return (
    <div className="modal fixed w-full h-screen top-0 left-0 flex flex-col items-center justify-center dark:text-white-text z-50 p-4 py-1">
      {/* <div className="absolute w-full h-full rounded-none bg-white-bg dark:bg-black-bg"></div> */}
      <form
        onSubmit={handleSubmit}
        className="modal-container bg-white-contents dark:bg-black-contents md:w-3/4 mx-auto mt- rounded-3xl shadow-lg z-50 overflow-y-auto h-full relative flex flex-col"
      >
          ...
          <div>
            <div className="mb-4">
              ...
              <div className="flex justify-end gap-6 lg:pr-20 mt-[-2rem]">
                <button
                  className="med-btn-sec-sm bg-green-pri"
                  type="button"
                  onClick={handlePaste}
                >
                  Paste All
        ...
        <div className="flex justify-center">
          <div className="sticky inset-x-0 bottom-0 pb-2 bg-white-contents dark:bg-black-contents">
            <button type="button" className="med-btn-sec" onClick={handleAdd}>
              Add Serials
            </button>
          </div>
        </div>
    ...
    //   <form
    //     onSubmit={handleSubmit}
    //     className="modal-container bg-white-contents dark:bg-black-contents md:w-3/4 mx-auto mt- rounded-3xl shadow-lg z-50 overflow-y-auto h-full relative"
    //   >
    //     <div className="modal-header flex flex-col h-32 text-center px-6 sticky top-0 z-50 bg-white-input dark:bg-black-fg">
    //       <div className="flex justify-end items-center pt-4 mb-[-1rem]">
    //         <CloseIcon onClick={onClose} fontSize="small cursor-pointer z-50" />
    ...
    //     <div className="modal-contents h-full py-10 text-left px-6">
    //       <div className="grid grid-cols-2 lg:grid-cols-3 gap-4">
    //         {Array.from({ length: numSerials }, (_, index) => (
    //           <div key={index} className="mb-4">
    //             <label className="block text-lg mb-2">
